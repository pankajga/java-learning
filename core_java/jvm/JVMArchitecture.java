...
public class JVMArchitecture {
	...
	static class LoadingClass {
		public static void main(String[] args) throws ClassNotFoundException {
			int count = 0;
			Class cls = Class.forName(String.class.getName()); // here we are getting class level details of String class i.e. java.lang.String
			Method[] methods = cls.getDeclaredMethods(); // Reflection API used
